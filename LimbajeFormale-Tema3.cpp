...
int main()
{
    ...
    cout << "Tabela de actiuni si de salt generate de Bison: " << endl<<endl;
  
    cout << "      ";
    for (int i = 0;i < actiuni.begin()->second.size();i++)
    {
        int lungime = to_string(i).size();
        cout <<i << setw(5 - lungime) << " ";
	}  
    cout << endl<<endl;
    ...
    for (auto& entry : actiuni) {
        ...
        {
            lungime = entry.second.at(i).size();
			cout << entry.second.at(i)<<setw(5-lungime)<< " ";
		}
        cout << endl;
    }
